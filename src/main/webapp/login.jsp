  ...
  <body class="container body--login">
    <div class="row d-flex justify-content-center align-items-center vh-100">
      ...
      <form
        action="login"
        method="post"
        class="form--login col-md-5 col-lg-4 col-xl-4 d-flex flex-column justify-content-center align-items-center gap-3 bg-light rounded p-4"
      >
        <span
          class="logo--login bg-dark text-white d-flex justify-content-center align-items-center"
