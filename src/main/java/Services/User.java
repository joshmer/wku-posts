...
public class User {
    ...
    private static final String insertUserQuery = "INSERT INTO users (first_name, last_name, username, password, role) VALUES (?, ?, ?, ?, ?)";
    // private static final String updateUserQuery = "UPDATE users SET firstName = ?, lastName = ?, username = ?, password = ?, role = ? WHERE id = ?";
    ...
    public static int addUser(String firstName, String lastName, String username, String password, String role) {
        try (
                Connection con = DBConnect.getConnection();
    ...
    public static int removeUser(int id) {
        try (
                Connection con = DBConnect.getConnection();
                PreparedStatement deleteUser = con.prepareStatement(deleteUserQuery);) {
